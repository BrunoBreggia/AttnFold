...
def set_seed(seed=78):
    ...
    if tr.cuda.is_available():
        ...
        tr.cuda.manual_seed_all(seed)  # Para GPUs múltiples
        
    # 4. Configuración de algoritmos deterministas en PyTorch
    # Esto puede reducir la velocidad, pero asegura resultados idénticos
    tr.backends.cudnn.deterministic = True
    tr.backends.cudnn.benchmark = False
    
    # 5. Semilla de entorno (para hashing, etc.)
