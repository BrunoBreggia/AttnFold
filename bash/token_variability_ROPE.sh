...
for i in "${!exps[@]}"
do
    python main.py train-attention "sample/train_tanda_17_${data[$i]}.csv" "Experimentos/TV_ROPE_seed_$1/exp_${exps[$i]}" --pos_enc rope --emb_dim 32 --seed $1 --epochs 100
...
for i in "${!exps[@]}"
do
    python main.py train-attention "sample/train_tanda_17_${data[$i]}.csv" "Experimentos/TV_ROPE_seed_$1/exp_${exps[$i]}" --pos_enc rope --emb_dim 64 --seed $1 --epochs 100
    python main.py test-attention "sample/train_tanda_17_${data[$i]}.csv" "Experimentos/TV_ROPE_seed_$1/exp_${exps[$i]}"
    python sample/visualization.py "17_${data[$i]}" "Experimentos/TV_ROPE_seed_$1/exp_${exps[$i]}"
    mv "Experimentos/TV_ROPE_seed_$1/exp_${exps[$i]}/matrices" "Experimentos/TV_ROPE_seed_$1/exp_${exps[$i]}/matrices_epochs100"
    mv "Experimentos/TV_ROPE_seed_$1/exp_${exps[$i]}/test_tanda_17_${data[$i]}.pdf" "Experimentos/TV_ROPE_seed_$1/exp_${exps[$i]}/test_17_${data[$i]}_epochs100.pdf"
...
for i in "${!exps[@]}"
do
    python main.py train-attention "sample/train_tanda_17_${data[$i]}.csv" "Experimentos/TV_ROPE_seed_$1/exp_${exps[$i]}" --pos_enc rope --emb_dim 128 --seed $1 --epochs 100
    python main.py test-attention "sample/train_tanda_17_${data[$i]}.csv" "Experimentos/TV_ROPE_seed_$1/exp_${exps[$i]}"
    python sample/visualization.py "17_${data[$i]}" "Experimentos/TV_ROPE_seed_$1/exp_${exps[$i]}"
    mv "Experimentos/TV_ROPE_seed_$1/exp_${exps[$i]}/matrices" "Experimentos/TV_ROPE_seed_$1/exp_${exps[$i]}/matrices_epochs100"
    mv "Experimentos/TV_ROPE_seed_$1/exp_${exps[$i]}/test_tanda_17_${data[$i]}.pdf" "Experimentos/TV_ROPE_seed_$1/exp_${exps[$i]}/test_17_${data[$i]}_epochs100.pdf"
...
for i in "${!exps[@]}"
do
    python main.py train-attention "sample/train_tanda_17_${data[$i]}.csv" "Experimentos/TV_ROPE_seed_$1/exp_${exps[$i]}" --pos_enc rope --emb_dim 256 --seed $1 --epochs 100
    python main.py test-attention "sample/train_tanda_17_${data[$i]}.csv" "Experimentos/TV_ROPE_seed_$1/exp_${exps[$i]}"
    python sample/visualization.py "17_${data[$i]}" "Experimentos/TV_ROPE_seed_$1/exp_${exps[$i]}"
    mv "Experimentos/TV_ROPE_seed_$1/exp_${exps[$i]}/matrices" "Experimentos/TV_ROPE_seed_$1/exp_${exps[$i]}/matrices_epochs100"
    mv "Experimentos/TV_ROPE_seed_$1/exp_${exps[$i]}/test_tanda_17_${data[$i]}.pdf" "Experimentos/TV_ROPE_seed_$1/exp_${exps[$i]}/test_17_${data[$i]}_epochs100.pdf"
...
for i in "${!exps[@]}"
do
    python main.py train-attention "sample/train_tanda_17_${data[$i]}.csv" "Experimentos/TV_ROPE_seed_$1/exp_${exps[$i]}" --pos_enc rope --emb_dim 512 --seed $1 --epochs 100
    python main.py test-attention "sample/train_tanda_17_${data[$i]}.csv" "Experimentos/TV_ROPE_seed_$1/exp_${exps[$i]}"
    python sample/visualization.py "17_${data[$i]}" "Experimentos/TV_ROPE_seed_$1/exp_${exps[$i]}"
    mv "Experimentos/TV_ROPE_seed_$1/exp_${exps[$i]}/matrices" "Experimentos/TV_ROPE_seed_$1/exp_${exps[$i]}/matrices_epochs100"
    mv "Experimentos/TV_ROPE_seed_$1/exp_${exps[$i]}/test_tanda_17_${data[$i]}.pdf" "Experimentos/TV_ROPE_seed_$1/exp_${exps[$i]}/test_17_${data[$i]}_epochs100.pdf"
